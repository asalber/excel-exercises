...
The database fields are gender, race, state, years of education, study level and the yearly earnings.
Open the workbook and do the following operations:
\begin{enumerate}
\item Format the data list as a table.
...
\item Summarize the data list giving the average yearly earnings by gender. 
\item Create a pivot table and a column pivot chart with the following summaries: 
\begin{enumerate}
...
\item The average yearly earnings by state in rows and by gender in columns.
\item The average yearly earnings and education years by state in rows an by gender in columns.
\item The average yearly earnings by gender and race for workers with a master degree or a doctorate. 
...
doctorate and yearly earnings under \$ $30,000$. 
\end{enumerate}
\item Calculate the average yearly earnings for workers that meet the following criteria:
\begin{enumerate}
\item Male from Ohio.
\item Black male from Ohio.
\item Black male from Ohio with less than 10 years of education. 
\item Black or male from Ohio or Indiana with less than 10 years of education. 
\end{enumerate}
\end{enumerate}


\item The workbook
\href{http://aprendeconalf.es/office/excel/exercises/databases/spanish-debt.xlsx}{\textsf{spanish-debt.xlsx}}
