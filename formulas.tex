...
\item Use conditional formatting to apply to range D3:D10 a red font colour if the number of days is greater than or
equal to 360, a yellow colour if the number of days is between  180 and 350 and a green colour if the number of days is
between 90 and 179. 
\item Save de workbook.
\end{enumerate}
...
The message should be ``Increase salary'' if RSS$>$5, ``Fire seller'' if RSS$<$3 and ``Nothing'' in any other case.
